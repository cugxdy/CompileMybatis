...
public class XMLConfigBuilder extends BaseBuilder {
  ...
  private XMLConfigBuilder(XPathParser parser, String environment, Properties props) {
	...
	System.out.println("XMLConfigBuilder对象构造中");
...
/*  <settings>
    ...
    for (Object key : props.keySet()) {
      ...
      if (!metaConfig.hasSetter(String.valueOf(key))) {
    	// 当不存在该属性的Setter方法时,抛出BuilderException异常
...
/*    	<plugins>
        ...
        // 获取<plugin>节点下<property>配置的信息，并形成Properties对象
  ...
  private void objectFactoryElement(XNode context) throws Exception {
    if (context != null) {
      ...
      /*<objectFactory type="com.majing.learning.mybatis.reflect.objectfactory.ExampleObjectFactory">
       * 	<property name="someProperty" value="100"/>
       *</objectFactory>*/
      ...
      // 将objectFactory对象记录到Configuation对象的objectFactory属性中
  ...
  private void propertiesElement(XNode context) throws Exception {
    if (context != null) {
      ...
      // 解析<properties>的resource属性
      String resource = context.getStringAttribute("resource");
      // 获取url属性值
      String url = context.getStringAttribute("url");
      
      // 当resource与url都不存在时,抛出BuilderException异常
      ...
      // 获取configuration对象中的Properties属性值
